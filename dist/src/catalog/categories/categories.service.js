...
let CategoriesService = class CategoriesService {
    ...
    async remove(id) {
        ...
        if (category.children && category.children.length > 0) {
            throw new common_1.ConflictException('Cannot delete category because it has child categories');
        }
        if (category.products && category.products.length > 0) {
            throw new common_1.ConflictException('Cannot delete category because it has products');
        }
