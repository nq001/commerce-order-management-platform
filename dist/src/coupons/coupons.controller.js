...
__decorate([
    (0, permissions_decorator_1.Permissions)('CREATE_COUPON'),
    (0, common_1.Post)(),
...
__decorate([
    (0, permissions_decorator_1.Permissions)('VIEW_COUPON'),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, permissions_decorator_1.Permissions)('UPDATE_COUPON'),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, permissions_decorator_1.Permissions)('DELETE_COUPON'),
